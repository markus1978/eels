#source .pyenvhyperspy/bin/activate

"""mostly copied from: https://github.com/hyperspy/hyperspy/blob/RELEASE_next_minor/hyperspy/misc/eels/eelsdb.py
here all datasets from the EELS database are downloaded and the metadatas are saved due to changes in line 244 to 247"""
...
def eelsdb(spectrum_type=None, title=None, author=None, element=None, formula=None,
    ...
    if not spectra:
        ...
        for s in spectra:
            ...
            print(type(s.original_metadata.json)) #changes
            count += 1
            namekeks = 'metadata' + str(count) + '.txt'
            json_md.export(namekeks,encoding='utf8')
...
a = eelsdb()
#print(a[0].metadata.get_item("Sample.description"))
